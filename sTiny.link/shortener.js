...
var preferredDomain = `
<span id='preferredDomainText' class='button' R='border-bottom:white h(5) solid; font-size:h(35);' style='color:white;'>
  Use <b>domainName</b> domain
</span>
`
if (getParameter('from')){
    ...
    id('preferredDomainText').addEventListener('click', function() {
        alert("In order to use '" + getParameter('from') + "' as a shortener domain please enter the URL you want to shorten in the input box above and then click the 'Unique.domain' button (the black button).")
    })
}
